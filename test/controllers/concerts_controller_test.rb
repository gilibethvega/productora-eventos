...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { assistance: @concert.assistance, date: @concert.date, duration: @concert.duration, group_id: @concert.group_id, place: @concert.place } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { assistance: @concert.assistance, date: @concert.date, duration: @concert.duration, group_id: @concert.group_id, place: @concert.place } }
